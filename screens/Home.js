...
export default class HomeScreen extends Component {
  ...
  getArticle = () => {
    const url = "https://be47e9342416.ngrok.io/get-articles";
    axios
      .get(url)
      .then(response => {
  ...
  likedArtice = () => {
    const url = "https://be47e9342416.ngrok.io/liked-articles";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
  ...
  unlikedArticle = () => {
    const url = "https://be47e9342416.ngrok.io/disliked-articles";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
